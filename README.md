...
This study demonstrates that plasmid invasion and persistence are governed by the interplay between plasmid cost, segregational loss, conjugation rate, and selective pressures on plasmid-free cells. Deterministic analysis identifies a clear invasion threshold, showing that plasmids require a minimum transfer rate that increases linearly with both fitness cost and loss rate, although segregational loss is typically the dominant limitation while cost contributes a smaller, additive effect. ODE simulations confirm that selective pressure lowers this threshold, facilitating plasmid persistence even when costs are substantial, and stochastic simulations reveal that demographic noise can delay invasion or allow rare survival near the threshold. Under moderate to strong selective pressures, stochastic outcomes closely match deterministic predictions, with plasmids reliably establishing and dominating the population. Overall, these results highlight that conjugation-mediated persistence depends not solely on cost, but primarily on the balance between horizontal transfer and inheritance stability, providing a quantitative criterion for predicting plasmid fate consistent with theoretical and empirical studies of plasmid dynamics and antibiotic resistance spread.
